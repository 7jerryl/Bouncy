...
class RenderedComponent extends React.Component {
  ...
  grabRandomColor(color) {
    ...
    let green = Math.round(Math.random() * 128 + 127).toString(16);
    // We either return a specified color, or a random one.
  ...
  render() {
    ...
    return <Child parentFunction={this.grabRandomColor} />;
  }
}
...
ReactDOM.render(<RenderedComponent />, document.getElementById("app"));
